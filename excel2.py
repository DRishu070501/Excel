...
def update_filter_entries(column_count):
    ...
    filter_entries = [tk.Entry(filter_frame, width=10) for _ in range(column_count)]
...
tk.Button(button_frame, text="Highlight", command=highlight_cells_or_rows).pack(side=tk.LEFT, padx=5, pady=5)

# Highlight mode selection
highlight_mode = tk.StringVar(value="Cell")
tk.Radiobutton(button_frame, text="Highlight Cell", variable=highlight_mode, value="Cell").pack(side=tk.LEFT)
tk.Radiobutton(button_frame, text="Highlight Row", variable=highlight_mode, value="Row").pack(side=tk.LEFT)
tk.Radiobutton(button_frame, text="Highlight Column", variable=highlight_mode, value="Column").pack(side=tk.LEFT)
