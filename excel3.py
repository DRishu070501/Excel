...
tk.Button(button_frame, text="Reset Highlight", command=reset_highlight).pack(side=tk.LEFT, padx=5, pady=5)

# Highlight Mode (Cell, Row, Column)
highlight_mode = tk.StringVar(root, "Cell")
highlight_mode_menu = ttk.OptionMenu(button_frame, highlight_mode, "Cell", "Row", "Column")
highlight_mode_menu.pack(side=tk.LEFT, padx=5, pady=5)
